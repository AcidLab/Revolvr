...
<div class="row">
    ...
    <div class="col-md-2 offset-md-10"  style="text-align: center;">
        <a href="{{route('medias.create')}}" class="btn btn-primary btn-icon-split" style="width:100%;">
                                        ...
                                        <tbody>
                                           @foreach($medias as $row)
                                           		...
                                           		<td style="text-align: center;">
                                           			 <a href="{{route('medias.edit',$row->id)}}" class="btn btn-primary btn-circle">
                                                           <i class="fas fa-edit"></i>
                                                        </a>
                                                        <a href="{{route('media.delete',$row->id)}}" class="btn btn-danger btn-circle">
