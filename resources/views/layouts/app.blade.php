...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('home')}}">
            ...
            <div class="sidebar-brand-text mx-3">Revolver</div>
        </a>
        ...
        <!-- Nav Item - Dashboard -->
        <li class="nav-item {{preg_match('/advertiser/',\Request::route()->getName()) ? 'active' : ''}}">
            <a class="nav-link" href="{{route('advertisers.index')}}">
          <i class="fas fa-fw fa-table"></i>
          <span>Annonceurs</span></a>
        </li>
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('medias.index')}}">Médias</a>
            <a class="collapse-item" href="{{route('skills.index')}}">Skills</a>
            <a class="collapse-item" href="{{route('tags.index')}}">Tags</a>
            <a class="collapse-item" href="{{route('animals.index')}}">Animeaux domestiques</a>
            <a class="collapse-item" href="{{route('foods.index')}}">Food</a>
            <a class="collapse-item" href="{{route('brands.index')}}">Marques</a>
            <h6 class="collapse-header">Physique</h6>
            <a class="collapse-item" href="{{route('haircolors.index')}}">Couleur des cheveux</a>
            <a class="collapse-item" href="{{route('hairstyles.index')}}">Style des cheveux</a>
            <a class="collapse-item" href="{{route('eyecolors.index')}}">Couleur des yeux</a>
            <a class="collapse-item" href="{{route('carnations.index')}}">Carnation</a>
          </div>
        </div>
      </li>
